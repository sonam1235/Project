...
void calculate_b(int n,int adj[n][n],float B[n][n],int m)
	{
		for(int i=0;i<n;i++)
			{
...
void modularity(int n,float B[n][n],int label[],int m)
	{
		float Q=0.0;
                float sum=0.0;
		for(int i=0;i<n;i++)
